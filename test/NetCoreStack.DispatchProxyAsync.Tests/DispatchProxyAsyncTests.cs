...
namespace NetCoreStack.DispatchProxyAsyncTests
{
    public static class DispatchProxyAsyncTests
    {
        [Fact]
        ...
        {
            TestType_InternalInterfaceService proxy = DispatchProxyAsync.Create<TestType_InternalInterfaceService, TestDispatchProxyAsync>();
            Assert.NotNull(proxy);
        }
        ...
        {
            Assert.Throws<ArgumentException>("TProxy", () => DispatchProxyAsync.Create<TestType_IHelloService, Sealed_TestDispatchProxyAsync>());
        }
        ...
        public static void Invoke_Receives_Correct_MethodInfo_And_Arguments()
        {
            ...
            TestType_IHelloService proxy = System.Reflection.DispatchProxyAsync.Create<TestType_IHelloService, TestDispatchProxyAsync>();
            Assert.NotNull(proxy);

            TestDispatchProxyAsync DispatchProxyAsync = proxy as TestDispatchProxyAsync;
            Assert.NotNull(DispatchProxyAsync);

            // Redirect Invoke to our own Func above
            DispatchProxyAsync.CallOnInvoke = invokeCallback;
